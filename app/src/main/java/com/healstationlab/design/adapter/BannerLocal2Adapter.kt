...
class BannerLocal2Adapter(private val imageList : ArrayList<BannerLocal>) :
    RecyclerView.Adapter<BannerLocal2Adapter.ViewHolder>() {

    private lateinit var imgView : ImageView
    var isiArray = ArrayList<PopUpNewBanner>()

    private lateinit var itemClickListener: BannerLocal2Adapter.ItemClickListener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.home_viewapger_item,
            parent,false)
        Log.d("size-image", imageList.size.toString())
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imageView.setOnClickListener {
            if (imageList[position].getIdImage() ==2){
            ...
            }else if (imageList[position].getIdImage() == 3){
